...
records <- readRDS(file.path(root, "results/p11_scz_neff_audit/corrected_p25_final/p25_phbc_records.rds"))$full
n_block <- 200L
...
out <- file.path(root, "results/p11_scz_neff_audit/corrected_supplementary")
